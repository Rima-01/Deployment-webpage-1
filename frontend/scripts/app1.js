...
async function fetchPosters() {
    const API_URL = "http://34.239.234.119:8001/videos/get_videos/"; // Replace with your backend API URL
    const videoGrid = document.getElementById("video-grid");
...
async function fetchAndPlayVideo() {
    ...
    const API_URL = `http://34.239.234.119:8001/videos/play_video/${videoId}/`;
